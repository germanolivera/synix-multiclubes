...
export default function Jugadores() {
    ...
    const filteredPlayers = players.filter(p => {
        ...
        return matchSearch && matchDeporte && matchNivel
    })
    const handleExportCSV = () => {
        // Headers
        const headers = ['Nombre', 'Apellido', 'Email', 'Telefono', 'DNI', 'Deportes_Niveles']
    ...
    return (
        <div className="h-full flex flex-col max-w-6xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-8 space-y-6">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    <h1 className="text-2xl font-bold text-textMain tracking-tight">Jugadores</h1>
                    <p className="text-sm text-textMuted mt-1">
                        Gestiona la base de datos de clientes de tu club
                    </p>
                </div>
                        ...
                        <table className="w-full text-left border-collapse">
                            <thead>
                                <tr className="border-b border-border bg-background/50">
                                    <th className="px-6 py-4 text-xs font-semibold text-textMuted uppercase tracking-wider">Jugador</th>
                                    ...
                                    <tr>
                                        <td colSpan={4} className="px-6 py-12 text-center">
                                            <div className="flex flex-col items-center justify-center">
                                                ...
                                                <h3 className="text-lg font-medium text-textMain">No se encontraron jugadores</h3>
                                                <p className="text-sm text-textMuted mt-1">
                                                    {searchTerm ? 'Prueba con otros términos de búsqueda.' : 'Comienza añadiendo clientes a tu club.'}
                                                </p>
                                            </div>
                                        </td>
                                    </tr>
